...
<div class="loginContainer" style="margin: 30px 0 0 135px">
    ...
    <form action="" method="POST" style="display: inline">
        <div style="display: inline-block">
            ...
            <br>
            <input name="firstName" placeholder="Max" class="loginTextfield" id="signupFirstName" type="text"
                   style="margin: 10px 50px 40px 0; width: 250px" required>
        </div>
        <div style="display: inline-block">
            <label class="inputLabel" for="signupLastName">Last Name</label>
            <br>
            <input name="lastName" placeholder="Mustermann" class="loginTextfield" id="signupLastName" type="text"
                   style="margin: 10px 0 40px 0; width: 250px" required>
        </div>
        <br>
        <label class="inputLabel" for="signupEmail">Email</label>
        <br>
        <input onkeyup="validate()" name="email" placeholder="example@mail.net" class="loginTextfield" id="signupEmail"
               type="text" style="margin: 10px 0 40px 0; width: 560px" required>
        <br>
        <div style="display: inline-block">
            <label class="inputLabel" for="signupPassword">Password</label>
            <br>
            <input name="password" class="loginTextfield" id="signupPassword" type="password"
                   style="margin: 10px 50px 40px 0; width: 250px" required>
        </div>
        <div style="display: inline-block">
            <label class="inputLabel" for="signupVerifyPassword">Verify Password</label>
            <br>
            <input onkeyup="checkIfPasswordsMatch()" class="loginTextfield" id="signupVerifyPassword" type="password"
                   style="margin: 10px 0 40px 0; width: 250px" required>
        </div>
        <br>
        <label class="inputLabel">Preferred Measurement System</label>
        <br>
        <input style="margin-top: 20px" class="radioSignup" name="preferredMeasUnit" id="radioMetric" type="radio"
        ...
        <br>
        <button name="submit" id="loginButton" style="width: 220px; margin-top: 20px; display: inline-block"
                class="loginButton" type="submit">CREATE ACCOUNT
        </button>
    ...
    <script type="text/javascript">
        ...
        function enableButton() {
            ...
            sendButton.onmouseenter = function () {
                sendButton.style.backgroundColor = "#29A744"
            };
        }
