<div class="greeting">
    ...
    <img id="scrollGif" onmouseover="document.getElementById('scrollGif').style.cursor = 'pointer'" onclick="scrollDown()" src="../sources/Scroll.gif" style="height: 100px; width: 100px; margin-left: 650px" alt="scroll gif">
